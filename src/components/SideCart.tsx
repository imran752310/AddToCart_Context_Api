  ...
  return (
    ...
    >
      <div className="p-4 flex justify-between">
        ...
        <button onClick={()=>clearCart()} className="uppercase text-sm">Clear</button>
      </div>
...
return(
      <div key={cartItem.product.id} className="p-4">
        <div className="flex space-x-4">
          ...
          <div className="ml-auto">
            <button onClick={()=> removeFromCart(cartItem.product)} className="text-xs uppercase hover:underline">
              Remove
            </button>
      ...
      <div className="mt-auto p-4">
        ...
        onClick={()=>{
          if(isLoggedIn){
            console.log("send Data to the server create payment link");
