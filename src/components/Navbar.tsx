...
//           <button
//           onClick={()=> setShowSideCart((old)=> !old)}
//           className="bg-gray-200 p-3 rounded-full relative cursor-pointer">
//             <CartIcon color="#011627" size={16} />
//             {cartItems > 0 ? (
...
//       </nav>
//     </div>
//     <Navbar visible={showSideCart} onRequestClose={()=>setShowSideCart(false)} />
//   </>
//   );
// };
